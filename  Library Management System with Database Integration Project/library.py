...
class Library:
    ...
    def checkout_book(self): #An error occurred: cannot access local variable 'user_library_id' where it is not associated with a value
        try:
            ...
            if user == "no":
                ...
                if verified_isbn:
                    ...
                    if user_library_id.isdigit():
                        user_id = int(user_library_id) #I feel like user_id and user_library_id ae the same thing??
